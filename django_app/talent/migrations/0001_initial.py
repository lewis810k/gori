# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-04-03 12:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curriculum_rate', models.IntegerField(default=1, help_text='5이하의 숫자를 입력하세요', validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
                ('readiness_rate', models.IntegerField(default=1, help_text='5이하의 숫자를 입력하세요', validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
                ('timeliness_rate', models.IntegerField(default=1, help_text='5이하의 숫자를 입력하세요', validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
                ('delivery_rate', models.IntegerField(default=1, help_text='5이하의 숫자를 입력하세요', validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
                ('friendliness_rate', models.IntegerField(default=1, help_text='5이하의 숫자를 입력하세요', validators=[django.core.validators.MaxValueValidator(5), django.core.validators.MinValueValidator(1)])),
            ],
        ),
        migrations.CreateModel(
            name='Talent',
            fields=[
                ...
                ('class_type', models.IntegerField(choices=[(0, '1:1 수업'), (1, '그룹 수업'), (2, '원데이 수업')], default=1)),
